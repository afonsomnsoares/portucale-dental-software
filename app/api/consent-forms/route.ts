...
export const GET = withRoute({ permission: 'consent-forms:read', tenant: 'optional' }, async ({ request, user }) => {
...
export const POST = withRoute({ permission: 'consent-forms:manage', tenant: 'optional' }, async ({ request, user }) => {
