...
import { Empty, GhostBtn, Metric, MetricStrip, PanelBar, PanelNote, Sel, Spinner } from '@/components/ui';
...
export default function RecuperacaoPanel() {
  const { api } = useAuth();
  ...
  return (
    <div>
      ...
      <PanelNote>Oportunidades de receita — ligue ao doente certo hoje.</PanelNote>
