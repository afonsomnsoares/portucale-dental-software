...
import { basePathFor, formatEUR } from '@/lib/constants';
...
export default function ReportsPage() {
  ...
  // Same dual-mount situation as components/admin/pages/Invoices.tsx.
        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, minmax(0, 1fr))', gap: 16, marginBottom: 16 }}>
            ...
            <MetricCard
              ...
              sub={<Link href={`${basePath}/recovery`}>Ver detalhe em Recuperação →</Link>}
              color="var(--red)"
            />
          </div>
